...
<?php
	...
	if(isset($_POST['update'])){
		...
		if(empty($_POST["image"])){
			$sql = "update users SET fullName = '$name', email = '$email', password = '$pwd', gender = '$gender' where userName = '$userName1'";
		}
		else{
			$sql = "update users SET fullName = '$name', email = '$email', password = '$pwd', gender = '$gender', image = '$image' where userName = '$userName1'";
		}
...
<body>
	...
	<div class = "container">
			<div class = "row">
				...
				<div class = "col-lg-6">
					<div id = "interface">
						<form class = "form-group text-center" action = "adminEdit.php" method = "post" onsubmit = "return chckPassword()">
							...
							<a href = "adminHome.php"><input type = "button" name = "back" value = "Back" class = "btn btn-primary btn-block"></a>
						</form>
					</div>
				</div>
				<div class = "col-lg-3"></div>
